<script lang="ts">
	...
	let {
		...
		selectedTool?: Tool;
		currentColor?: string; // Added currentColor prop
		onSelectAll: () => void;
		onDeselectAll: () => void;
...
<div class="toolbar">
	...
	<div class="toolbar-section">
		...
		<div class="tool-buttons">
			<button
				class:active={selectedTool === 'select_cursor'}
				onclick={() => (selectedTool = 'select_cursor')}
				title="Select Single"
			>
				<svg viewBox="0 0 24 24" width="16" height="16">
					<path d="M7 2l12 11.2-5.8.5 3.3 7.3-2.2 1-3.2-7-4.1 4z" fill="currentColor" />
			...
			<button
				class:active={selectedTool === 'select_box'}
				onclick={() => (selectedTool = 'select_box')}
				title="Select Box"
			>
				<svg viewBox="0 0 24 24" width="16" height="16">
					<rect
	...
	<div class="toolbar-section">
		...
		<div class="tool-buttons">
			<button
				...
				onclick={() => (selectedTool = 'move')}
				title="Move Selected"
			>
				<svg viewBox="0 0 24 24" width="16" height="16">
					<path
						d="M12 5v14 M5 12h14 M8 8l-3 4 3 4 M16 8l3 4-3 4 M8 8l4-3 4 3 M8 16l4 3 4-3"
						stroke="currentColor"
						stroke-width="1.5"
						fill="none"
					/>
